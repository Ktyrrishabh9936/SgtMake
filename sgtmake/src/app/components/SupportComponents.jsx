  ...
  return <>
    <div className="">
      <div className="">
        ...
        Answer="Our warranty covers defects in materials and workmanship that arise during normal use. This includes failures due to faulty components or manufacturing errors. We will repair or replace the defective part or product, ensuring it functions according to its intended specifications. 
        If a direct replacement is not available, we will provide a comparable product or component. This warranty is limited to the original purchaser and is non-transferable." />
        <ServicesWarrantyCard 
        Question="03. Exclusion" 
        Answer="While we stand behind the quality of our products, certain exclusions apply to our warranty. Damage caused by misuse, abuse, neglect, accidents, unauthorized repairs, or modifications is not covered. Normal wear and tear, cosmetic damage, and damage resulting from improper installation or environmental factors are also excluded.
         Additionally, consumable items and accessories are not covered under this warranty.
         Please refer to the product manual for detailed information on proper usage and maintenance." />
        <ServicesWarrantyCard 
        Question="04. Warranty Registration Information" 
        Answer="To ensure prompt service and to activate your warranty, we encourage you to register your product within [Number] days of purchase. Warranty registration can be completed online through our website at [Website Address] or by submitting the enclosed registration card.
         Registering your product allows us to keep you informed about product updates, recalls, and special offers. It also streamlines the warranty claim process, ensuring faster and more efficient service." />
      </div>
    </div>
  </>
}

function ServicesWarrantyCard({Question, Answer}){
  return<>
    <div className="p-2">
      <div className="text-xl font-semibold">
        {Question}
